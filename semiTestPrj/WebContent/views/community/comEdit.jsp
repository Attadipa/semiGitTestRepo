...
<body>
    ...
    <div id="outer">
        ...
        <form action="/semiTestPrj/community/edit" method="post">
	       		<input type="submit" id="submit" class="btn btn-success" value="등록"><hr>
            <div id="section">
            	<input type="hidden" name="num" value="<%=vo.getNo()%>">
	            <input type="hidden" name="writerNo" value="<%=loginMember.getMemberNo()%>"><br>
                <input type="text" size="120" name="title" id="title" placeholder=" 제목을 입력해주세요." value="<%=vo.getTitle()%>" required onkeyup="title_check();"><br><br>
