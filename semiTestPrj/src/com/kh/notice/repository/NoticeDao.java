...
public class NoticeDao {
	...
	public ArrayList<NoticeVo> selectList(Connection conn, PageVo pageVo) {
		...
		//sql 준비
		String sql = "SELECT * FROM ( SELECT ROWNUM AS RNUM, T.* FROM ( SELECT N.NO , N.TITLE , N.CONTENT , N.CNT , N.ENROLL_DATE , M.MEMBER_MID AS WRITER FROM NOTICE N JOIN MEMBER M ON N.WRITER = M.MEMBER_NO WHERE N.STATUS = 'N' ORDER BY N.NO DESC ) T ) WHERE RNUM BETWEEN ? AND ?";
